...
def run(indata):
    ...
    y = butter_bandpass_filter(x, lowcut, highcut, fs, order=3) # filtered audio, limiting frequencies to 200-1000Hz
    ...
    peaks, _ = find_peaks(ffthz, distance=50, height=100)
